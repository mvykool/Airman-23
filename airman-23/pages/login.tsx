...
<div className='bg-gray-200 pt-10 pb-44 login md:h-screen md:flex md:justify-center md:pr-[10%]'>
      <Head>
        <title>Air man 23 | Login</title>
        <meta name="description" content="Generated by create next app" />
   
      </Head>
     <div className='grid place-items-center py-14 px-10 mx-[20%] md:w-[22vw] md:py-5 md:h-[55vh] login-card bg-white mt-36 rounded-md shadow-lg'>
