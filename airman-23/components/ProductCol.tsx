...
const ProductCol = ({ product} : Product) => {
  ...
  return (
    ...
    <motion.div 
       ...
       whileInView="show"
       viewport={{ once: true }}
       className='bg-white rounded-2xl shadow-lg my-4 mx-4 p-5 md:w-[18vw] md:h-[45vh] md:my-10 hover:scale-110 hover:shadow-2xl duration-300 relative overflow-hidden'>
       <div>
