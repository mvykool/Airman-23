...
const Cards = () => {
  return (
    <div className='mt-10 md:w-[60vw] flex flex-col md:flex-row gap-4 md:justify-center md:space-x-3'>
        {/**card 1 */}
        <motion.div 
       ...
       whileInView="show"
       viewport={{ once: true }}
        className='bg-white md:h-[30vh] flex flex-col rounded-sm shadow-lg hover:scale-105 duration-300 hover:shadow-2xl'>
            <div className='p-4 md:p-6 flex md:flex-1 relative justify-between md:block md:px-20' >
        ...
        <Link href={'/shipping'}>
            <button className='text-white relative bottom-0 font-semibold h-10 md:text-sm md:h-14 bg-[#00708c] duration-100 hover:bg-[#005469] w-full rounded-b-sm'>
                    Check more info
            </button>
        </Link>
