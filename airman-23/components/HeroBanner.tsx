...
const HeroBanner = ({heroBanner}: Props) => {
  return (
    ...
    <motion.div 
       ...
       whileInView="show"
       viewport={{ once: true }}
    className='mx-5 md:mx-2 bg-orange-400 rounded-sm my-10 md:w-[20vw] hover:scale-105 duration-300 hover:bg-orange-500 hover:shadow-md'>
        <div className='md:px-2'>
          ...
          <div className='mt-5'>
           ...
           <div className='ml-14 mb-6 mt-7 md:mt-10 line'>
          ...
          <Link href={`/product/${heroBanner.product}`}>
            <button className='ml-10 -mt-10 md:mt-10 mb-5 p-2 md:text-xs bg-black text-white rounded-sm' type='button'>{heroBanner.buttonText}</button>
          </Link>
