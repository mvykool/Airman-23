...
const SecondHeroBanner = ({heroBanner}: Props) => {
  return (
    <div className='mx-5 bg-red-400 rounded-sm my-10 md:w-[28vw]'>
    <div  className='md:px-5'>
        ...
        <div className='mt-5'>
         ...
         <div className='ml-2 mb-6 mt-10 md:mt-2 line'>
    ...
    <div>
      <Link href={`/product/${heroBanner.product}`}>
        <button className='ml-1 -mt-10 mb-5 p-2 md:p-3  bg-black text-white rounded-sm' type='button'>{heroBanner.buttonText}</button>
      </Link>
